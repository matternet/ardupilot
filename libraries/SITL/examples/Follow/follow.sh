...
(cd swarm/plane && $PLANE --model plane --uartA tcp:0 --defaults $PLANE_DEFAULTS) &
...
(cd swarm/copter && $COPTER --model quad --uartA tcp:0 --instance 1 --defaults $COPTER_DEFAULTS,follow.parm) &
wait
