...
void SIM_Precland::update(const Location &loc, const Vector3f &position)
{
    ...
    Location_Class origin_center {};
    origin_center.lat = _origin_lat * 1.0e7f;
    origin_center.lng = _origin_lon * 1.0e7f;
    origin_center.alt = _origin_height;
    origin_center.flags.relative_alt = 1;
