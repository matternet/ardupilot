...
const ToneAlarm_ChibiOS::Tone ToneAlarm_ChibiOS::_tones[] {
...
void ToneAlarm_ChibiOS::play_tone(const uint8_t tone_index)
{
...
void ToneAlarm_ChibiOS::play_string(const char *str) {
    hal.util->toneAlarm_play_string(str);
}

void ToneAlarm_ChibiOS::stop_cont_tone() {
...
void ToneAlarm_ChibiOS::check_cont_tone() {
    uint32_t tnow_ms = AP_HAL::millis();
