...
private:
    ...
    const uint32_t _mavlink_dynamic_period_ms = 900; //how often are mavlink dynamic messages sent in ms. E.g. 1000 = 1 Hz
    const uint32_t _mavlink_static_period_ms = 2900; //how often are mavlink static messages sent in ms
