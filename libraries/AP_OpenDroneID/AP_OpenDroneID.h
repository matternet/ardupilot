...
private:
    ...
    const uint32_t _mavlink_dynamic_period_ms = 800; //how often are mavlink dynamic messages sent in ms. E.g. 1000 = 1 Hz. Send slightly faster than 1 Hz.
    const uint32_t _mavlink_static_period_ms = 2800; //how often are mavlink static messages sent in ms. E.g. 3000 = 1/3 Hz. Send slightly faster than 1/3 Hz.
