...
/*
 * Init and run calls for ebrake flight mode
 */

// ebrake_init - initialise ebrake controller
bool ModeEBrake::init(bool ignore_checks)
{
...
// ebrake_run - runs the ebrake controller
...
void ModeEBrake::timeout_to_loiter_ms(uint32_t timeout_ms)
{
    _timeout_start = millis();
    _timeout_ms = timeout_ms;
}

void ModeEBrake::init_target()
{
