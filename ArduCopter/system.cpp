...
void Copter::update_auto_armed()
{
    ...
    if(ap.auto_armed){
        ...
        } else if (motors->armed() && !ap.using_interlock && flightmode->mode_number() != Mode::Number::AUTO && flightmode->mode_number() != Mode::Number::GUIDED) {
